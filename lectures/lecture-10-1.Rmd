...
Today and upcoming: Final Project information out!
...
The "final project" will make up the context of the next five homework assignments. The first three will be the individual steps that comprise the bulk of the project material; the final two will be geared toward the "supporting documentation" and "final writeup" portions of the presentation that you will give on December 7. All details will be released this week.

The data source of the project: publicly available data from Twitter. Today and leading into the homework assignment we will be collecting data from Twitter sources to do comparative prediction studies across many settings. Each student will have a slightly different focus (a different university in the SEC +) but using the same basic concepts as each other student.

For this, we're going to use a package constructed for the purpose:
...
This package has a few different functions to access the Twitter API. For it to work, you need access credentials. You would also need a Twitter account, so if you want to get access on your own (and you should, for this), you can do it from here:

[http://davetang.org/muse/2013/04/06/using-the-r_twitter-package/]
[http://www.r-bloggers.com/getting-started-with-twitter-in-r/]

If you can't get this to go, I'll give you permission through the course account.
